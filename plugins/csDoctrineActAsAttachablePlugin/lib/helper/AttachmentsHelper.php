...
{
	include_component('csAttachable', 'attachments', array('form'             => $form,
	                                                       'javascriptHelper' => 'jQuery'));
}
...
function translateAttachmentType($type = '')
{
	$type = strtolower(trim($type));
	$translate = array('document'           => 'Документы',
	                   'image'              => 'Фотографии анкеты и торговой точки',
	                   'video'              => 'Видео',
	                   'audio'              => 'Аудио-запись визита',
