...
<?php if($attachment->getType()=='image'):?>
  <?php echo link_to(image_tag($attachment->getAttachmentResizedRoute(10,10), array('alt_title'=>$title)), image_path($attachment->getOriginalUrl()), 'class=link target=_blank') ?>
<?php else:?>
