...
<table class="table table-bordered table-striped">
	...
	<tr>
		...
		<td><?php echo $worksheet['outlet_manager'] ?></td>
	</tr>
	<tr>
		<td>Должность сотрудника РТТ</td>
		<td><?php echo $worksheet['outlet_manager_position'] ?></td>
	</tr>
	<tr>
		<td>Контактный телефон РТТ</td>
		<td><?php echo $worksheet['outlet_phone'] ?></td>
	</tr>
</table>
<table class="table">
<tr>
...
<table class="table table-bordered table-striped">
	...
	<tr>
		<td>Дата визита</td>
		<td>
			<?php echo date('d.m.Y',strtotime($worksheet['created_at'])) ?>
		</td>
	</tr>
	<tr>
		<td>Время визита</td>
