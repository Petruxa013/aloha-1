...
<table class="table table-bordered table-striped">
	<tr>
		...
		<td>
			...
			<p>
				- переписаны аудитором вручную ассортимент, имеющейся в торговом зале и на складе РТТ <br />
				- переписаны с распечатки, предоставленной сотрудником магазина <br />
				- записаны со слов сотрудника магазина <br />
				- не получены (написать по какой причине)
			</p>
		</td>
	</tr>
	<tr>
