	...
	<div class="navbar-wrapper">
		<div class="navbar">
			<div class="navbar-inner">
				...
				<a class="brand" href="/">Панель управления проектом</a>
...
<div class="alert container">
	<h3>Уважаемы аудиторы и координаторы, мы проводим срочные работы на сервере. Возвращайтесь через 15 минут.</h3>
</div>
